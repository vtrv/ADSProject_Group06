...
object uopc extends ChiselEnum {
  val isADD, isSUB, isXOR, isOR, isAND, isSLL, isSRL, isSRA, isSLT, isSLTU,
      isADDI, isXORI, isORI, isANDI, isSLLI, isSRLI, isSRAI, isSLTI, isSLTIU,
      isNOP, isInvalid,
      // New Control Flow Micro-operations
